@extends('app')
@section('custom_css')
    <link href="{{url('assets/frontend/css/skins/square/grey.css')}}" rel="stylesheet">
    <link href="{{url('assets/frontend/css/date_time_picker.css')}}" rel="stylesheet">
@stop
@section('slider')
...
@section('js_custom')
    ...
    <!-- Specific scripts -->
    <script src="{{asset('assets/frontend/js/typeahead.jquery.js')}}"></script>
    <script src="{{url('assets/frontend/js/icheck.js')}}"></script>
    <script src="{{url('assets/frontend/js/bootstrap-datepicker.js')}}"></script>
    <script src="{{url('assets/frontend/js/bootstrap-timepicker.js')}}"></script>
    <script src="{{url('assets/frontend/js/jquery.ddslick.js')}}"></script>
    ...
    <script>
        ...
        // code for Typehead js

        // End code for Typehead js
    </script>
@stop